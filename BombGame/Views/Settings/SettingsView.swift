                ...
                VStack(spacing: 16) {
                    ...
                    ZStack(alignment: .topLeading) {
                        ...
                        VStack(spacing: 15) {
                            ...
                            TimeButtons(
                                textOne: "Короткое", textTwo: "Среднее",
                                funcOne: { settingsVM.setGameTime(time: 10) },
                                funcTwo: { settingsVM.setGameTime(time: 20) }
                            )
                            
                            TimeButtons(
                                textOne: "Длинное", textTwo: "Случайное",
                                funcOne: { settingsVM.setGameTime(time: 45) },
                                funcTwo: { settingsVM.setGameTime(time: Int.random(in: 10...45)) }
                            )
                        }
                    }
                    .overlay {
                    ...
                    ZStack {
                        ...
                        VStack(spacing: 15) {
                            MusicSetButtons(
                                sound: $settingsVM.backgroundMusic,
                            ...
                            MusicSetButtons(
                                sound: $settingsVM.bombSound,
                                musicVariant: .bomb,
                                title: MusicVariant.bomb.rawValue,
                                sounds: settingsVM.bombSounds
                            )
                            
                            MusicSetButtons(
                                sound: $settingsVM.explosionSound,
                                musicVariant: .explosion,
                                title: MusicVariant.explosion.rawValue,
                                sounds: settingsVM.explosionSounds
                            )
                        }
                    }
                    .overlay {
